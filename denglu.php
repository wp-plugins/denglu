...
<div class="wrap">
  <h2>Denglu评论</h2>
	  ...
	  <h3>自定义key时的回调地址</h3>
	  <p><code><?php echo plugins_url('denglu') . '/dl_receiver.php';?></code></p>
	  <p>提示：请确保“微博开放平台”的回调地址与<a href="http://open.denglu.cc/" target="_blank">灯鹭控制台</a>->回调地址里面的“填写转发地址”处填写的一致。</p>
</div>
<?php
}