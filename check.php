...
<body>
<h3>环境检查</h3>
<p>当前服务器时间：<?php echo date("Y-m-d H:i:s",time() + 8 * 60 * 60);?> <a style="color:#f50" href="check.php">刷新</a> <a style="color:#f50" href="http://www.denglu.cc/source/wordpress_faqs.html#phptime" target="_blank">详细</a></p>
<table id="t1">
  <thead>
    <tr>
      <th>项目</th>
